<%@ Page Title="List Level Master" Language="C#" MasterPageFile="~/Institute.master" AutoEventWireup="true" CodeFile="ListLevel.aspx.cs" Inherits="ListLevel" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var oTable = $('#datatable').DataTable({
                ...
                bServerSide: true,
                sAjaxSource: 'ListPage.asmx/ListLevel',
                sServerMethod: 'post',
