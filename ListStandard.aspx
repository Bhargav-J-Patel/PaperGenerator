<%@ Page Title="List Standard Master" Language="C#" MasterPageFile="~/Institute.master" AutoEventWireup="true" CodeFile="ListStandard.aspx.cs" Inherits="ListStandard" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var oTable = $('#datatable').DataTable({
                ...
                bServerSide: true,
                sAjaxSource: 'ListPage.asmx/ListStandard',
                sServerMethod: 'post',
