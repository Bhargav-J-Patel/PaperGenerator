<%@ Page Title="List Question Master" Language="C#" MasterPageFile="~/Institute.master" AutoEventWireup="true" CodeFile="ListMasterQuestion.aspx.cs" Inherits="ListMasterQuestion" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var oTable = $('#datatable').DataTable({
                ...
                bServerSide: true,
                sAjaxSource: 'ListPage.asmx/ListQuestion',
                sServerMethod: 'post',
            ...
            <div class="widget-box">
                <div class="widget-header">
                    <div style="float: left">
                        <h4 class="widget-title">List Question Master</h4>
                    </div>
                            ...
                            <table id="datatable" width="100%" class="table table-responsive table-bordered table-hover"
                                ...
                                <thead>
                                    <tr style="background-color: #2A3F54; color: #fff; height: 34px;">
                                        <th style="width: 100px; padding: 5px 0px 5px 5px;">NID
                                        </th>
                                        <th style="width: 100px; padding: 5px 0px 5px 5px;">Medium
                                        </th>
                                        <th style="width: 100px; padding: 5px 0px 5px 5px;">Standard
                                        </th>
                                        <th style="width: 100px; padding: 5px 0px 5px 5px;">Subject
                                        </th>
                                        <th style="width: 100px; padding: 5px 0px 5px 5px;">Chapter Name
                                        </th>
                                        <th style="width: 100px; padding: 5px 0px 5px 5px;">Answer Key
                                        </th>
