<%@ Page Title="List Chapter" Language="C#" MasterPageFile="~/Institute.master" AutoEventWireup="true" CodeFile="ListChapter.aspx.cs" Inherits="ListChapter" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var oTable = $('#datatable').DataTable({
                ...
                bServerSide: true,
                sAjaxSource: 'ListPage.asmx/ListChapter',
                sServerMethod: 'post',
