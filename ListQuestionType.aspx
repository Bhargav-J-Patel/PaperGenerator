<%@ Page Title="List QuestionType" Language="C#" MasterPageFile="~/Institute.master" AutoEventWireup="true" CodeFile="ListQuestionType.aspx.cs" Inherits="ListQuestionType" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var oTable = $('#datatable').DataTable({
                ...
                bServerSide: true,
                sAjaxSource: 'ListPage.asmx/ListQuestionType',
                sServerMethod: 'post',
