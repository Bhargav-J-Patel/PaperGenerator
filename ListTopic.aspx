<%@ Page Title="List Topic" Language="C#" MasterPageFile="~/Institute.master" AutoEventWireup="true" CodeFile="ListTopic.aspx.cs" Inherits="ListTopic" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var oTable = $('#datatable').DataTable({
                ...
                bServerSide: true,
                sAjaxSource: 'ListPage.asmx/ListTopic',
                sServerMethod: 'post',
