<%@ Page Title="List Subject" Language="C#" MasterPageFile="~/Institute.master" AutoEventWireup="true" CodeFile="ListSubject.aspx.cs" Inherits="ListSubject" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var oTable = $('#datatable').DataTable({
                ...
                bServerSide: true,
                sAjaxSource: 'ListPage.asmx/ListSubject',
                sServerMethod: 'post',
