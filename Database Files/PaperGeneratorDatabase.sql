...
----------- Date : 22/04/2018 / By Devanshi Pujara

ALTER PROCEDURE [dbo].[usp_GetQuetionTypeMaster]
@DisplayLength int,
@DisplayStart int,
@SortCol int,
@SortDir nvarchar(10),
...
/****** Object:  StoredProcedure [dbo].[usp_GetTopicMaster]    Script Date: 4/22/2018 12:15:27 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[usp_GetTopicMaster]
@DisplayLength int,
@DisplayStart int,
@SortCol int,
@SortDir nvarchar(10),
...
BEGIN
	...
	(
		SELECT ROW_NUMBER() OVER (ORDER BY 
								...
								tm.nTopic_Index,
								tm.cTopicName,
								'<a href="MasterTopic.aspx?ID='+ convert(nvarchar(100),cTopic_ID) +'&E=1" title="Edit"><img src="assets/img/edit.png" />' as cedit,
								'<a href="MasterTopic.aspx?ID='+ convert(nvarchar(100),cTopic_ID) +'&D=1" title="Delete"><img src="assets/img/delete.png" /></a>' as cdelete
								--'' as editdelete,
								--'' as cedit, '' as cdelete
								FROM Tbl_TopicMaster(nolock) tm 
								INNER JOIN Tbl_ChapterMaster(nolock) cm on cm.cChapter_ID = tm.cChapter_ID
...
/****** Object:  StoredProcedure [dbo].[usp_GetComboList]    Script Date: 4/22/2018 12:15:27 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[usp_GetComboList]
@Type as varchar(20),
@Id  as varchar(100),
@cCompany_ID as varchar(100)
as
...
/****** Object:  StoredProcedure [dbo].[usp_GetChapterMaster]    Script Date: 4/22/2018 12:15:27 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[usp_GetChapterMaster]
@DisplayLength int,
@DisplayStart int,
@SortCol int,
@SortDir nvarchar(10),
...
BEGIN
	...
	(
		SELECT ROW_NUMBER() OVER (ORDER BY 
								...
								mm.cMedium,
								sm.cStandardName,
								subm.cSubjectName,nChaper_Index,cChapterName,
								'<a href="MasterChapter.aspx?ID='+ convert(nvarchar(100),cChapter_ID) +'&E=1" title="Edit"><img src="assets/img/edit.png" />' as cedit,
								'<a href="MasterChapter.aspx?ID='+ convert(nvarchar(100),cChapter_ID) +'&D=1" title="Delete"><img src="assets/img/delete.png" /></a>' as cdelete
								--'' as editdelete,
								--'' as cedit, '' as cdelete
								FROM Tbl_ChapterMaster(nolock) cm
								INNER JOIN Tbl_SubjectMaster(nolock) subm on subm.cSubject_ID = cm.cSubject_ID
...
/****** Object:  StoredProcedure [dbo].[usp_GetSubjectMaster]    Script Date: 4/22/2018 12:15:27 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[usp_GetSubjectMaster]
@DisplayLength int,
@DisplayStart int,
@SortCol int,
@SortDir nvarchar(10),
...
BEGIN
	...
	(
		SELECT ROW_NUMBER() OVER (ORDER BY 
								...
								sm.cStandardName,
								subm.cSubjectName,
								'<a href="MasterSubject.aspx?ID='+ convert(nvarchar(100),cSubject_ID) +'&E=1" title="Edit"><img src="assets/img/edit.png" />' as cedit,
								'<a href="MasterSubject.aspx?ID='+ convert(nvarchar(100),cSubject_ID) +'&D=1" title="Delete"><img src="assets/img/delete.png" /></a>' as cdelete
								--'' as editdelete,
								--'' as cedit, '' as cdelete
								FROM Tbl_SubjectMaster(nolock) subm
								INNER JOIN Tbl_StandardMaster(nolock) sm on sm.cStandard_ID = subm.cStandard_ID
...
/****** Object:  StoredProcedure [dbo].[usp_GetLevelMaster]    Script Date: 4/22/2018 12:15:27 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[usp_GetLevelMaster]
@DisplayLength int,
@DisplayStart int,
@SortCol int,
@SortDir nvarchar(10),
...
BEGIN
	...
	(
		SELECT ROW_NUMBER() OVER (ORDER BY 
								...
								count(*) OVER() as TotalCount,
								cLevelName,
								'<a href="MasterLevel.aspx?ID='+ convert(nvarchar(100),cLevel_ID) +'&E=1" title="Edit"><img src="assets/img/edit.png" />' as cedit,
								'<a href="MasterLevel.aspx?ID='+ convert(nvarchar(100),cLevel_ID) +'&D=1" title="Delete"><img src="assets/img/delete.png" /></a>' as cdelete
								--'' as editdelete,
								--'' as cedit, '' as cdelete
								FROM Tbl_LevelMaster(nolock) LM   
								WHERE LM.cCompany_ID =@compid and (@Search IS NULL
...
/****** Object:  StoredProcedure [dbo].[usp_GetStandardMaster]    Script Date: 4/22/2018 12:15:27 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[usp_GetStandardMaster]
@DisplayLength int,
@DisplayStart int,
@SortCol int,
@SortDir nvarchar(10),
...
BEGIN
	...
	(
		SELECT ROW_NUMBER() OVER (ORDER BY 
								...
								mm.cMedium,
								sm.cStandardName,
								'<a href="MasterStandard.aspx?ID='+ convert(nvarchar(100),sm.cStandard_ID) +'&E=1" title="Edit"><img src="assets/img/edit.png" />' as cedit,
								'<a href="MasterStandard.aspx?ID='+ convert(nvarchar(100),sm.cStandard_ID) +'&D=1" title="Delete"><img src="assets/img/delete.png" /></a>' as cdelete
								--'' as editdelete,
								--'' as cedit, '' as cdelete
								FROM Tbl_StandardMaster(nolock) sm
								INNER JOIN Tbl_MidiumMaster(nolock) mm ON mm.cMedium_ID = sm.cMedium_ID
...
/****** Object:  StoredProcedure [dbo].[usp_CurdStandardMaster]    Script Date: 4/22/2018 12:15:27 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[usp_CurdStandardMaster]
(
@Type AS VARCHAR(10),
@cStandard_ID AS VARCHAR(100),
@cMedium_ID AS VARCHAR(100),
...
/****** Object:  StoredProcedure [dbo].[usp_SearchMaster]    Script Date: 4/22/2018 12:15:27 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[usp_SearchMaster]
@Type as varchar(20),
@Id  as varchar(100)
as
begin
...
/****** Object:  StoredProcedure [dbo].[usp_GetLogin]    Script Date: 4/22/2018 12:15:27 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[usp_GetLogin]
@type as nvarchar(250),
@username as nvarchar(250),
@password as nvarchar(250)
