<%@ Page Title="Question Heading" Language="C#" MasterPageFile="~/Institute.master" AutoEventWireup="true" CodeFile="ListQuestionHeading.aspx.cs" Inherits="ListQuestionHeading" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var oTable = $('#datatable').DataTable({
                ...
                bServerSide: true,
                sAjaxSource: 'ListPage.asmx/ListQuestionHeading',
                sServerMethod: 'post',
                ...
                <div class="widget-header">
                    <div style="float: left">
                        <h4 class="widget-title">
                            List Question Heading Master</h4>
                    </div>
